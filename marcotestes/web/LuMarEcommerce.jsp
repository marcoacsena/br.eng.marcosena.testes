  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="bolapraia.jpg" class="img-responsive" style="width:60%" alt="Bola de vôlei de praia"></div>
        <div class="panel-footer">A melhor bola de vôlei de praia!</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-danger">
        <div class="panel-heading">Violão Takasena.</div>
        <div class="panel-body"><img src="takamine.jpg" class="img-responsive" style="width:60%" alt="Violão Takamine"></div>
        <div class="panel-footer">Violão Takasena corda de Lynon!</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-success">
        <div class="panel-heading">Celuar Senasung</div>
        <div class="panel-body"><img src="celular.jpg" class="img-responsive" style="width:70%" alt="Image"></div>
        <div class="panel-footer">Celuar M10 top de linha!</div>
      </div>
    </div>
  </div>
</div><br>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-footer">Carro modelo MS500 500 CV!</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
